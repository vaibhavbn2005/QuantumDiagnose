...
# ============================================================
# QISKIT DISEASE PREDICTION (CALIBRATED)
# ============================================================
...
def build_report_email_html(payload):
    ...
    if doctors:
        d = doctors[0]
        doctor_html = f"""
        <tr><td style="padding-top:14px; color:#68748a; font-size:13px;">Recommended Doctor</td></tr>
        <tr><td style="padding:4px 0 0; color:#182238; font-weight:700;">{d.get('name', '')} &middot; {d.get('specialization', '')}</td></tr>
        <tr><td style="padding:2px 0 0; color:#68748a; font-size:13px;">{d.get('hospital', '')}, {d.get('location', '')}</td></tr>
        """
    ...
    <div style="font-family:Arial,Helvetica,sans-serif; background:#f4f7fb; padding:28px 12px;">
      <div style="max-width:560px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #e1e7f0;">
        <div style="background:linear-gradient(135deg, #315bea, #4d70ef); padding:22px 28px;">
          ...
          <div style="color:#dce6ff; font-size:12px; margin-top:2px;">Hybrid AI-Assisted Symptom Analysis Report</div>
        </div>
        <div style="padding:26px 28px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f7f9fc; border-radius:12px; padding:16px; margin-bottom:18px;">
            <tr>
              <td style="padding:6px 12px;">
                <p style="margin:0; color:#68748a; font-size:12px;">Hybrid Prediction</p>
                ...
                <p style="margin:2px 0 0; color:#315bea; font-size:13px; font-weight:700;">
                  {float(payload.get('hybrid_confidence', 0)):.2f}% confidence
                </p>
              </td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:8px;">{top_rows}</table>
          <table width="100%" cellpadding="0" cellspacing="0">{doctor_html}</table>
          <div style="margin-top:22px; padding:14px 16px; background:#fff8e8; border:1px solid #f4e2b5; border-radius:10px;">
            <p style="margin:0; color:#755a1d; font-size:12px; line-height:1.6;">
              <strong>Important:</strong> QuantumDiagnose is an educational research demonstration.
            </p>
          </div>
